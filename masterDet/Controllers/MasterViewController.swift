...
//        navigationItem.rightBarButtonItem = addButton
    ...
    func insertNewObject(_ sender: Any) {
        ...
        newBudget.category_name = "Catogoty 1"
        newBudget.amount = 45.00
...
//        newEvent.timestamp = Date()
    ...
    func configureCell(_ cell: UITableViewCell, withBudget budget: Budget) {
        cell.textLabel!.text = budget.category_name
        cell.detailTextLabel?.text = "£ " + String(budget.amount)
    }
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
        switch type {
            ...
            case .update:
                configureCell(tableView.cellForRow(at: indexPath!)!, withBudget: anObject as! Budget)
            case .move:
                configureCell(tableView.cellForRow(at: indexPath!)!, withBudget: anObject as! Budget)
